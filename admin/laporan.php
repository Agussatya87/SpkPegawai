...
<body bgcolor="f0f0f0">
  ...
  <div class="container bg-light shadow p-3 mb-5">
      ...
      <table class="table table-striped shadow">
        ...
        ?>
          ...
          <tr>
            ...
            <td>
              <a href="detail_laporan.php?kode=<?= $hasil_akhir['kode']; ?>" class="btn btn-info">Details</a>
              <a href="hapus_laporan.php?kode=<?= $hasil_akhir['kode']; ?>" class="btn btn-danger">Delete</a>
    ...
    <br><br>
    <h6 class="text-riwayat"><span class="bg-light">Riwayat Ranking Terbaru</span></h6>
